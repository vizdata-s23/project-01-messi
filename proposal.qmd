...
The first plot will examine goal scoring trends across world cups in order to examine the effect of new rules on the outcomes of games. We are **planning** to create a scatterplot showing the number of goals scored during each world cup and/or during each game. We will add annotations on top of this graph to show when certain changes were implemented in the World Cup, hopefully to highlight/explain changes in patterns.
